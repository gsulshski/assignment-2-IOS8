...
{
    NSLog(@"%s Empty Deck", __PRETTY_FUNCTION__);
...
{
    NSLog(@"%s Test One Card ", __PRETTY_FUNCTION__);
    Deck *deck = [[Deck alloc] init];
...
{
    NSLog(@"%s Test Two Random Cards ", __PRETTY_FUNCTION__);
    Deck *deck = [[Deck alloc] init];
...
{
    NSLog(@"%s Test Multiple Random Cards ", __PRETTY_FUNCTION__);
    Deck *deck = [[Deck alloc] init];
